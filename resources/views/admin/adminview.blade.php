...
<head>
    ...
    <style>
        ...
        .admin-brand-text{font-weight:700;letter-spacing:.08em;text-transform:uppercase;font-size:.85rem;}
        .admin-nav{flex:1;padding:1.25rem .75rem;}
        ...
        .admin-nav-link:hover{background:var(--sidebar-bg-soft);color:#fff;}

        .admin-sidebar-footer{
            padding:.9rem 1rem 1.2rem;
            border-top:1px solid rgba(148,163,184,.35);
        }
        .admin-logout-btn{width:100%;border-radius:.55rem;font-size:.85rem;font-weight:600;padding:.45rem .75rem;}
        ...
        .admin-content{flex:1;padding:1.5rem 1.75rem 2rem;}
...
<div class="admin-wrapper">
   ...
   class="admin-nav-link {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
    Dashboard
            ...
            {{-- Khách hàng --}}
            <a href="#" class="admin-nav-link">Quản li khách hàng</a>
            {{-- <a href="#" 
    ...
    <main class="admin-main">
        <header class="admin-topbar">
            <div class="admin-topbar-title">@yield('page_title')</div>
        </header>
